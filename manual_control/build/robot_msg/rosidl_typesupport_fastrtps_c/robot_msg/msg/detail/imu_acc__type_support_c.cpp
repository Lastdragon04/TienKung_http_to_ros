...
#include "robot_msg/msg/detail/imu_acc__rosidl_typesupport_fastrtps_c.h"
...
using _ImuAcc__ros_msg_type = robot_msg__msg__ImuAcc;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ImuAcc__ros_msg_type * ros_message = static_cast<const _ImuAcc__ros_msg_type *>(untyped_ros_message);
  // Field name: bus
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ImuAcc__ros_msg_type * ros_message = static_cast<_ImuAcc__ros_msg_type *>(untyped_ros_message);
  // Field name: bus
  {
    std::string tmp;
    cdr >> tmp;
...
size_t get_serialized_size_robot_msg__msg__ImuAcc(
  const void * untyped_ros_message,
...
static uint32_t _ImuAcc__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_msg__msg__ImuAcc(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_msg
size_t max_serialized_size_robot_msg__msg__ImuAcc(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_msg__msg__ImuAcc;
    is_plain =
      (
...
static size_t _ImuAcc__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_msg__msg__ImuAcc(
...
static message_type_support_callbacks_t __callbacks_ImuAcc = {
  "robot_msg::msg",
  "ImuAcc",
...
static rosidl_message_type_support_t _ImuAcc__type_support = {
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_msg, msg, ImuAcc)() {
  return &_ImuAcc__type_support;
}
