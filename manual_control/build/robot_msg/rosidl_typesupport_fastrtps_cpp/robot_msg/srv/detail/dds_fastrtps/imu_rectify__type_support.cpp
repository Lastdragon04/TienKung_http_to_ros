...
#include "robot_msg/srv/detail/imu_rectify__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_msg::srv::ImuRectify_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_msg::srv::ImuRectify_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_msg::srv::ImuRectify_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ImuRectify_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const robot_msg::srv::ImuRectify_Request *>(
...
static size_t _ImuRectify_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ImuRectify_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ImuRectify_Request__callbacks = {
  "robot_msg::srv",
  "ImuRectify_Request",
...
static rosidl_message_type_support_t _ImuRectify_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ImuRectify_Request__callbacks,
...
{
  return &robot_msg::srv::typesupport_fastrtps_cpp::_ImuRectify_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robot_msg::srv::ImuRectify_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_msg::srv::ImuRectify_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<robot_msg::srv::ImuRectify_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ImuRectify_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const robot_msg::srv::ImuRectify_Response *>(
...
static size_t _ImuRectify_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ImuRectify_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ImuRectify_Response__callbacks = {
  "robot_msg::srv",
  "ImuRectify_Response",
...
static rosidl_message_type_support_t _ImuRectify_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ImuRectify_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &robot_msg::srv::typesupport_fastrtps_cpp::_ImuRectify_Response__handle;
}
...
static service_type_support_callbacks_t _ImuRectify__callbacks = {
  "robot_msg::srv",
  "ImuRectify",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_msg, srv, ImuRectify_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_msg, srv, ImuRectify_Response)(),
...
static rosidl_service_type_support_t _ImuRectify__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ImuRectify__callbacks,
...
{
  return &robot_msg::srv::typesupport_fastrtps_cpp::_ImuRectify__handle;
}
