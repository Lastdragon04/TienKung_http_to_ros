...
#include "robot_msg/msg/detail/serial_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_msg::msg::SerialData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_msg::msg::SerialData & ros_message)
{
  // Member: data
  cdr >> ros_message.data;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_msg::msg::SerialData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_msg::msg::SerialData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_msg::msg::SerialData *>(
    untyped_ros_message);
...
{
  return &robot_msg::msg::typesupport_fastrtps_cpp::_SerialData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_msg, msg, SerialData)() {
  return &robot_msg::msg::typesupport_fastrtps_cpp::_SerialData__handle;
}
