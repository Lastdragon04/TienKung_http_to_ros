...
#include "robot_msg/msg/detail/imu_angle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_msg::msg::ImuAngle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_msg::msg::ImuAngle & ros_message)
{
  // Member: bus
  cdr >> ros_message.bus;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_msg::msg::ImuAngle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_msg::msg::ImuAngle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_msg::msg::ImuAngle *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ImuAngle__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const robot_msg::msg::ImuAngle *>(
...
static size_t _ImuAngle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ImuAngle(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ImuAngle__callbacks = {
  "robot_msg::msg",
  "ImuAngle",
...
static rosidl_message_type_support_t _ImuAngle__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ImuAngle__callbacks,
...
{
  return &robot_msg::msg::typesupport_fastrtps_cpp::_ImuAngle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_msg, msg, ImuAngle)() {
  return &robot_msg::msg::typesupport_fastrtps_cpp::_ImuAngle__handle;
}
