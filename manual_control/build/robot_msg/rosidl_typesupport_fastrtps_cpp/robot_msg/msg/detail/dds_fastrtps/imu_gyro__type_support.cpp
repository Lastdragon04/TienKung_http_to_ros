...
#include "robot_msg/msg/detail/imu_gyro__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_msg::msg::ImuGyro & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_msg::msg::ImuGyro & ros_message)
{
  // Member: bus
  cdr >> ros_message.bus;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_msg::msg::ImuGyro;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_msg::msg::ImuGyro *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_msg::msg::ImuGyro *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ImuGyro__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const robot_msg::msg::ImuGyro *>(
...
static size_t _ImuGyro__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ImuGyro(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ImuGyro__callbacks = {
  "robot_msg::msg",
  "ImuGyro",
...
static rosidl_message_type_support_t _ImuGyro__handle = {
...
{
  return &robot_msg::msg::typesupport_fastrtps_cpp::_ImuGyro__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_msg, msg, ImuGyro)() {
  return &robot_msg::msg::typesupport_fastrtps_cpp::_ImuGyro__handle;
}
