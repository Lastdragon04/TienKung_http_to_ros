...
static const _CacheSet_Request_type_support_symbol_names_t _CacheSet_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_msg, srv, CacheSet_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_msg, srv, CacheSet_Request)),
  }
};
...
{
  return &::robot_msg::srv::rosidl_typesupport_cpp::CacheSet_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robot_msg, srv, CacheSet_Request)() {
  return get_message_type_support_handle<robot_msg::srv::CacheSet_Request>();
}
...
static const _CacheSet_Response_type_support_symbol_names_t _CacheSet_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_msg, srv, CacheSet_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_msg, srv, CacheSet_Response)),
  }
};
...
{
  return &::robot_msg::srv::rosidl_typesupport_cpp::CacheSet_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robot_msg, srv, CacheSet_Response)() {
  return get_message_type_support_handle<robot_msg::srv::CacheSet_Response>();
}
...
static const _CacheSet_type_support_symbol_names_t _CacheSet_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_msg, srv, CacheSet)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_msg, srv, CacheSet)),
  }
};
...
{
  return &::robot_msg::srv::rosidl_typesupport_cpp::CacheSet_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, robot_msg, srv, CacheSet)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<robot_msg::srv::CacheSet>();
}
