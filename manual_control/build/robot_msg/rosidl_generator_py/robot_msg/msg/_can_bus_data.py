...
class CanBusData(metaclass=Metaclass_CanBusData):
    ...
    def __init__(self, **kwargs):
        ...
        self.can_data = array.array('h', kwargs.get('can_data', []))
    ...
    def __eq__(self, other):
        ...
        if self.can_id != other.can_id:
            return False
        if self.can_data != other.can_data:
            return False
    ...
    def can_data(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'h', \
                "The 'can_data' array.array() must have the type code of 'h'"
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'can_data' field must be a set or sequence and each value of type 'int' and each integer in [-32768, 32767]"
        self._can_data = array.array('h', value)
