...
bool robot_msg__msg__can_bus_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_msg.msg._can_bus_data.CanBusData", full_classname_dest, 38) == 0);
  }
  robot_msg__msg__CanBusData * ros_message = _ros_message;
  {  // can_id
  ...
  {  // can_data
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int16_t * dest = ros_message->can_data.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'can_data'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
PyObject * robot_msg__msg__can_bus_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_msg.msg._can_bus_data");
  ...
  {  // can_data
    ...
    if (ros_message->can_data.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int16_t * src = &(ros_message->can_data.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->can_data.size * sizeof(int16_t));
      assert(data != NULL);
