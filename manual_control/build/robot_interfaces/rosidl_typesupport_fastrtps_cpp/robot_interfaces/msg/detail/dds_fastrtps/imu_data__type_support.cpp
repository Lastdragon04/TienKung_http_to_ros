...
#include "robot_interfaces/msg/detail/imu_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_interfaces::msg::ImuData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_interfaces::msg::ImuData & ros_message)
{
  // Member: angle_x
  cdr >> ros_message.angle_x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_interfaces::msg::ImuData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_interfaces::msg::ImuData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_interfaces::msg::ImuData *>(
    untyped_ros_message);
...
{
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_ImuData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interfaces, msg, ImuData)() {
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_ImuData__handle;
}
