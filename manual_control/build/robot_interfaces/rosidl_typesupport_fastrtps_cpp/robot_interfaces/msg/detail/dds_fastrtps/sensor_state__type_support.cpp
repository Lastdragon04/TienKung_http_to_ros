...
#include "robot_interfaces/msg/detail/sensor_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const robot_interfaces::msg::ImuData &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  robot_interfaces::msg::ImuData &);
size_t get_serialized_size(
  const robot_interfaces::msg::ImuData &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const robot_interfaces::msg::SensorState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_interfaces::msg::SensorState & ros_message)
{
  // Member: header
  ...
  // Member: imu
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.imu[index], current_alignment);
    }
  }
  // Member: touch
  {
  ...
  size_t current_alignment)
{
  ...
  // Member: imu
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        robot_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_ImuData(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = robot_interfaces::msg::SensorState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_interfaces::msg::SensorState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_interfaces::msg::SensorState *>(
    untyped_ros_message);
...
{
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_SensorState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interfaces, msg, SensorState)() {
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_SensorState__handle;
}
