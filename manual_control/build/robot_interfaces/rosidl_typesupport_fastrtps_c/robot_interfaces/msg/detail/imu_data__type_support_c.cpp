...
#include "robot_interfaces/msg/detail/imu_data__rosidl_typesupport_fastrtps_c.h"
...
using _ImuData__ros_msg_type = robot_interfaces__msg__ImuData;
...
static uint32_t _ImuData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_interfaces__msg__ImuData(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_interfaces__msg__ImuData;
    is_plain =
      (
...
static size_t _ImuData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_interfaces__msg__ImuData(
