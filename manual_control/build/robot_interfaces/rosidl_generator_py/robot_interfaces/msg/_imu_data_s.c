...
bool robot_interfaces__msg__imu_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_interfaces.msg._imu_data.ImuData", full_classname_dest, 38) == 0);
  }
  robot_interfaces__msg__ImuData * ros_message = _ros_message;
  {  // angle_x
    ...
    ros_message->angle_x = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // angle_y
    ...
    assert(PyFloat_Check(field));
    ros_message->angle_y = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // angle_z
    ...
    assert(PyFloat_Check(field));
    ros_message->angle_z = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * robot_interfaces__msg__imu_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_interfaces.msg._imu_data");
