    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'robot_interfaces.msg.SensorState')
            logger.debug(
            ...
            from robot_interfaces.msg import ImuData
...
class SensorState(metaclass=Metaclass_SensorState):
    ...
    _fields_and_field_types = {
        ...
        'imu': 'sequence<robot_interfaces/ImuData>',
        'touch': 'sequence<uint8>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['robot_interfaces', 'msg'], 'ImuData')),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        self.imu = kwargs.get('imu', [])
        self.touch = array.array('B', kwargs.get('touch', []))
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, ImuData) for v in value) and
                 True), \
                "The 'imu' field must be a set or sequence and each value of type 'ImuData'"
        self._imu = value
    ...
    def touch(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'B', \
                "The 'touch' array.array() must have the type code of 'B'"
            self._touch = value
            return
        if __debug__:
            from collections.abc import Sequence
            ...
            assert \
                ...
                "The 'touch' field must be a set or sequence and each value of type 'int' and each unsigned integer in [0, 255]"
        self._touch = array.array('B', value)
