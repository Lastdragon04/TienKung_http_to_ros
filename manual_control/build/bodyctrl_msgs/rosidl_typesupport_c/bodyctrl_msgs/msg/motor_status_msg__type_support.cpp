...
static const _MotorStatusMsg_type_support_symbol_names_t _MotorStatusMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bodyctrl_msgs, msg, MotorStatusMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bodyctrl_msgs, msg, MotorStatusMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bodyctrl_msgs, msg, MotorStatusMsg)() {
  return &::bodyctrl_msgs::msg::rosidl_typesupport_c::MotorStatusMsg_message_type_support_handle;
}
