...
static const _SetMotorPosition_type_support_symbol_names_t _SetMotorPosition_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bodyctrl_msgs, msg, SetMotorPosition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bodyctrl_msgs, msg, SetMotorPosition)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bodyctrl_msgs, msg, SetMotorPosition)() {
  return &::bodyctrl_msgs::msg::rosidl_typesupport_c::SetMotorPosition_message_type_support_handle;
}
