...
#include "bodyctrl_msgs/msg/detail/motor_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = bodyctrl_msgs::msg::MotorStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const bodyctrl_msgs::msg::MotorStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<bodyctrl_msgs::msg::MotorStatus *>(
    untyped_ros_message);
...
{
  return &bodyctrl_msgs::msg::typesupport_fastrtps_cpp::_MotorStatus__handle;
}
